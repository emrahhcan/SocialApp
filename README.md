...
* Sessions are managed with JSON Web Token which means your log in time is limited within 1 hour. Then, you need to log in again because your unique token will change automaticly.
